...
/*********************************************************//**
*
* \brief Busca el �ltimo Id de cliente en el archivo
* \param ninguno
* \return int ultimoId - retorna el �ltimo id - 0 si est� vacio
*
***********************************************************/
int ultimoIdCliente()
{
...
/*int pasarDeArchivoToArreglo(char nombreArchivo[], stClientec cliente[], int v, int dim)
{
    ...
    if(archi!=NULL)
    {
        while((fread(&cliente[i],sizeof(stCliente), 1, archi)>0) && i<v)
        {
            aux = juancito[i];
            i++;
        }
...
* \return int v - la cantidad de registros - 0 si est� vac�o
*
***********************************************************/
